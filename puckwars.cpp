...
Image img[4] = {"./intro.png", "./background.png", 
	...
	int segs;
   	Circle() {
   		cx = 12.0f;
    		cy = 30.0f;
		segs = 360;
   		pos[0] = cx = gl.xres / 2.0;
   		pos[1] = cy = gl.yres / 4;
		vel[0] = vel[1] = 0.0;
    	}
	Circle(double r, double p0, double p1, double v1) {
    		radius = r;
		pos[0] = p0;
		pos[1] = p1;
		vel[0] = vel[1] = v1;
...
void render()
{
	...
	if (!gl.pressed) {
    	...
    	ggprint8b(&r, 20, 0x00ff0000, "PRESS Q TO CHANGE PADDLE SHAPE");
	}
	// Draw paddle
	glPushMatrix();
